...
public class Game 
{
    ...
    private ArrayList<Room> prevRooms = new ArrayList<Room>();
    ...
    {
        Room outside, theater, pub, lab, office, library;
    ...
    private boolean processCommand(Command command) 
    {
        ...
        if (commandWord.equals("back")){
            ...
            System.out.println("Can't");
                ...
                currentRoom = prevRooms.remove(prevRooms.size() - 1);
